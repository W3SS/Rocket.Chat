...
WebApp.connectHandlers.use('/livechat', Meteor.bindEnvironment((req, res, next) => {
	...
	const html = `<html>
		<head>
			<link rel="stylesheet" type="text/css" class="__meteor-css__" href="${ __meteor_runtime_config__.ROOT_URL_PATH_PREFIX }/livechat/livechat.css?_dc=${ Autoupdate.autoupdateVersion }">
		...
		<body>
			<script type="text/javascript" src="${ __meteor_runtime_config__.ROOT_URL_PATH_PREFIX }/livechat/livechat.js?_dc=${ Autoupdate.autoupdateVersion }"></script>
		</body>
	</html>`;
